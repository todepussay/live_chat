...
function conversations(req, res){
    ...
    db.query(
        `SELECT c.id AS conversation_id, u.id as other_user_id, u.username AS other_user_name, m.content AS last_message_content, m.id_user AS send_message_user, c.update_time AS last_update
